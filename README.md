...
3. Change directories using ```cd ...``` to the location of the downloaded files.
...
Please note that this video demo is from the original release. Many stylistic changes have been made since then, along with a significant expansion to the program, and this should only be used as a reference to how far the project has come since then.
